                        ...
                        <form method="post" class="bike-add-form-container" action="/newlog">
                            ...
                            <select name="Parent_Id" id="Parent_Id">
                                @foreach ($parents as $parent)
                                    <option value="{{ $parent->id }}">{{ $parent->Parent_brand }} {{ $parent->Parent_model }}</option>
                                @endforeach
                            </select>
                            <p>Ride Type</p>
                            ...
                            <p>Ride Notes</p>
                            <input class="" placeholder="e.g good day, check tyres next time" type="text" name="Log_info"
                                required>
                            <p>Ride Mileage</p>
